...
export default () => {
  ...
  return (
    <footer className="pt-10 bg-primary-400">
      <div className="max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="justify-between items-center gap-12 md:flex">
          ...
          <div className="flex-1 mt-6 md:mt-0">
            ...
            >
              ...
              <button
                type="submit"
                className="block w-auto py-3 px-4 font-medium text-sm text-center text-white  hover:bg-indigo-500 bg-red-600 active:shadow-none rounded-lg shadow"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
          ...
          <div className="flex items-center gap-x-6 text-gray-350 mt-6">
            <a
              target="-blank  "
              href="https://www.facebook.com/photo/?fbid=1058555788438606&set=a.142711860023008&__tn__=%3C"
            >
              <svg
                className="w-6 h-6 hover:text-white duration-150"
                fill="none"
                viewBox="0 0 48 48"
              >
                <g clip-path="url(#a)">
            ...
            <a href="https://www.facebook.com/photo/?fbid=1058555788438606&set=a.142711860023008&__tn__=%3C">
              <svg
                className="w-6 h-6 hover:text-white duration-150"
                fill="none"
                viewBox="0 0 48 48"
              >
                <g clip-path="https://www.facebook.com/me/">
                  <path
                    fill="currentColor"
            ...
            <a
              target="-blank"
              href="https://l.facebook.com/l.php?u=https%3A%2F%2Fwww.instagram.com%2Frawol.rupak%3Figsh%3DM2lwcXpkaWppdGdn%26utm_source%3Dqr%26fbclid%3DIwZXh0bgNhZW0CMTAAAR1hV97lSF8SyaMFDLE0gRSw8zAFK8k92Z5Gvhzl2CaLV4WD70k5G9QQq_c_aem_eAF1H1Thj62w63nYfNx1Hw&h=AT24Mo3fgqmtR1-777tZenXY0AYmWLRI_VzhpATUmJWPl3jPDA40ygFVaJpNcRHJrby7FJqeXYoPq2DKIDKxdWBGo4lLCafQZz6qwxFgHCt1WQAFQXN-IDWGoTFtzsVFnr7Ey1Rg1nqgAZ85ZtQxRnaCSsU"
            >
              <svg
                className="w-6 h-6 hover:text-white duration-150"
                fill="currentColor"
