export default () => {
  ...
  return (
    <section className="relative py-14  bg-primary-600">
      <div
          ...
          {plans.map((item, idx) => (
            <div
              ...
              className={`relative flex-1 flex items-stretch flex-col mt-6 border-2 sm:mt-0 sm:rounded-xl sm:max-w-md ${
                item.isMostPop
                  ? "bg-primary-550 border-white  border-x-0 sm:border-x-2"
                  : "border-transparent"
              }`}
            >
              <div className="p-4 py-8 space-y-4 border-b border-gray-700 md:p-8">
                ...
                <button className="px-3 py-3 rounded-lg w-full font-semibold text-sm duration-150 text-white bg-cyan-500 hover:bg-cyan-600 ">
                  Get Started
                </button>
              </div>
